...
namespace Minsk.Tests.CodeAnalysis
{
    public class EvaluationTests
    {
        ...
        [InlineData("[1, true, \"123\"]", new object[] { 1, true, "123" })]
        [InlineData("{ let obj = { a : int = 1, b : bool = true } return obj.a }", 1)]
        [InlineData("{ let obj = { a : int = 1, b : bool = true } return obj.b }", true)]
        [InlineData("{ let obj = { a : int = 1, b : bool = true } return obj.a + obj.a }", 2)]
        [InlineData("{ let t = { t1 = { t2 = { t3 : int = 5}}}  return t.t1.t2.t3 }", 5)]
        [InlineData("{ var x = [1, 2, 3] return x[1] }", 2)]
        [InlineData("{ var x = [1, 2, 3] var res = 0 for i = 0 to 2 { res = res + int(x[i]) } return res }", 6)]
        ...
        {
            EvaluationResult result = ParseAndEvaluate(text);
        ...
        private void AssertDiagnostics(string text, string diagnosticText)
        {
            ...
            var result = ParseAndEvaluate(annotatedText.Text);
        ...
        private static EvaluationResult ParseAndEvaluate(string text)
        {
