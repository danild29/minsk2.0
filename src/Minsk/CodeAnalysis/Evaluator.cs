...
namespace Minsk.CodeAnalysis
{
    ...
    internal sealed class Evaluator
    {
        ...
        private object? EvaluateExpression(BoundExpression node)
        {
            ...
            switch (node.Kind)
            {
                ...
                case BoundNodeKind.ArrayIndexExpression:
                    return EvaluateArrayIndexExpression((BoundArrayIndexExpression)node);
                ...
                case BoundNodeKind.ObjectReferenceExpression:
                    return EvaluateObjectReferenceExpression((BoundObjectReferenceExpression)node);
        ...
        private object? EvaluateArrayExpression(BoundArrayExpression node)
        {
            ...
            foreach (var item in node.BoundItems)
            {
        ...
        private object? EvaluateArrayIndexExpression(BoundArrayIndexExpression node)
        {
            var index = (int) EvaluateExpression(node.Expression);
            var array = EvaluateExpression(node.Variable) as IEnumerable<object>;
