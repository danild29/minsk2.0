...
namespace Minsk.CodeAnalysis.Binding
{
    internal static class BoundNodePrinter
    {
        ...
        public static void WriteTo(this BoundNode node, IndentedTextWriter writer)
        {
            switch (node.Kind)
            {
                ...
                case BoundNodeKind.ArrayIndexExpression:
                    WriteArrayIndexExpression((BoundArrayIndexExpression)node, writer);
                    break;
        ...
        private static void WriteArrayIndexExpression(BoundArrayIndexExpression node, IndentedTextWriter writer)
        {
            ...
            writer.WritePunctuation(SyntaxKind.OpenSquareBraceToken);
            node.Expression.WriteTo(writer);
            writer.WritePunctuation(SyntaxKind.CloseSquareBraceToken);
        }
